...
{proposalText && (
  <div className="mt-8">
    {(() => {
      ...
      return (
        <>
          {/* This div creates the spaced-out stack of cards */}
          <div className="flex flex-col gap-8">
            ...
            <ProblemSlide
              problems={
                Array.isArray(sections["Problem Statement"])
            ...
            <SolutionSlide
              solutions={
                Array.isArray(sections["Proposed Solution"])
          ...
          {/* Export buttons are placed below the stack of cards for a clean layout */}
          <div className="mt-8 flex gap-3">
            <button
              onClick={handleExportPDF}
              className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-transform transform hover:scale-105"
            >
              Export as PDF
            </button>
            <button
              onClick={handleExportDOCX}
              className="flex-1 bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-transform transform hover:scale-105"
            >
              Export as DOCX
            </button>
          </div>
